...
class RobotControllerCompletoI(drobots.ControllerCompleto):
	def __init__(self):
        self.robot = None
    ...
    def turn(self, current = None): 
        ...
        self.anguloScan = random.randint(0, 359)
    ...
    def accion(self, current = None):
        print("ACCION COMPLETO")
        if(self.energia > 10):
            self.escanear(self.anguloScan, self.amplitud)
